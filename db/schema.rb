...
ActiveRecord::Schema.define(version: 20161111165847) do
  ...
  add_index "contest_categories", ["contest_id", "category_id"], name: "index_contest_categories_on_contest_id_and_category_id", unique: true, using: :btree
